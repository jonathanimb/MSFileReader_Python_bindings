...
try:
    ...
    XRawfile2_dll_path.append(
        os.path.dirname(os.path.abspath(__file__)) + os.sep + 'XRawfile2_x64.dll')  # 64bits msFileReader aside raw.py
    XRawfile2_dll_path.append(
        u'C:\\Program Files\\Thermo\\MSFileReader\\XRawfile2_x64.dll')  # 64bits msFileReader with 64bits system
    XRawfile2_dll_path.append(
        os.path.dirname(os.path.abspath(__file__)) + os.sep + 'XRawfile2.dll')  # 32bits msFileReader aside raw.py
    XRawfile2_dll_path.append(
        u'C:\\Program Files (x86)\\Thermo\\MSFileReader\\XRawfile2.dll')  # 32bits msFileReader with 64bits system
    XRawfile2_dll_path.append(
        u'C:\\Program Files\\Thermo\\MSFileReader\\XRawfile2.dll')  # 32bits msFileReader with 32bits system
...
class ThermoRawfile(object):
    ...
    def Version(self):  # MSFileReader DLL version
        ...
        error = self.source.Version(byref(MajorVersion), byref(MinorVersion), byref(SubMinorVersion),
                                    byref(BuildNumber))
        if error: raise IOError("Version error {}".format(error))
    ...
    def GetFileName(self):
        ...
        if error: raise IOError("GetFileName error {}".format(error))
    ...
    def GetCreatorID(self):
        ...
        if error: raise IOError("GetCreatorID error {}".format(error))
    ...
    def GetVersionNumber(self):
        ...
        if error: raise IOError("GetVersionNumber error {}".format(error))
    ...
    def GetCreationDate(self):
        ...
        if error: raise IOError("GetCreationDate error {}".format(error))
    ...
    def IsError(self):
        ...
        if error: raise IOError("IsError error {}".format(error))
    ...
    def IsNewFile(self):
        ...
        if error: raise IOError("IsNewFile error {}".format(error))
    ...
    def IsThereMSData(self):
        ...
        if error: raise IOError("IsThereMSData error {}".format(error))
    ...
    def HasExpMethod(self):
        ...
        if error: raise IOError("HasExpMethod error {}".format(error))
    ...
    def InAcquisition(self):
        ...
        if error: raise IOError("InAcquisition error {}".format(error))
    ...
    def GetErrorCode(self):
        ...
        if error: raise IOError("GetErrorCode error {}".format(error))
    ...
    def RefreshViewOfFile(self):
        ...
        if error: raise IOError("RefreshViewOfFile error {}".format(error))
        return
    ...
    def GetNumberOfControllers(self):
        ...
        if error: raise IOError("GetNumberOfControllers error {}".format(error))
    ...
    def GetNumberOfControllersOfType(self, controllerType='MS'):
        ...
        if error: raise IOError("GetNumberOfControllersOfType error {}".format(error))
    ...
    def GetControllerType(self, index):
        ...
        if error: raise IOError("GetControllerType error {}".format(error))
    ...
    def SetCurrentController(self, controllerType, controllerNumber):
        ...
        if error: raise IOError("SetCurrentController error {}".format(error))
        return
    ...
    def GetCurrentController(self):
        ...
        if error: raise IOError("GetCurrentController error {}".format(error))
    ...
    def GetExpectedRunTime(self):
        ...
        if error: raise IOError("GetExpectedRunTime error {}".format(error))
    ...
    def GetNumTrailerExtra(self):
        ...
        if error: raise IOError("GetNumTrailerExtra error {}".format(error))
    ...
    def GetMaxIntegratedIntensity(self):
        ...
        if error: raise IOError("GetMaxIntegratedIntensity error {}".format(error))
    ...
    def GetMaxIntensity(self):
        ...
        if error: raise IOError("GetMaxIntensity error {}".format(error))
    ...
    def GetInletID(self):
        ...
        if error: raise IOError("GetInletID error {}".format(error))
    ...
    def GetErrorFlag(self):
        ...
        if error: raise IOError("GetErrorFlag error {}".format(error))
    ...
    def GetFlags(self):
        ...
        if error: raise IOError("GetFlags error {}".format(error))
    ...
    def GetAcquisitionFileName(self):
        ...
        if error: raise IOError("GetAcquisitionFileName error {}".format(error))
        return pbstrFileName.value
    ...
    def GetAcquisitionDate(self):
        ...
        if error: raise IOError("GetAcquisitionDate error {}".format(error))
    ...
    def GetOperator(self):
        ...
        if error: raise IOError("GetOperator error {}".format(error))
    ...
    def GetComment1(self):
        ...
        if error: raise IOError("GetComment1 error {}".format(error))
    ...
    def GetComment2(self):
        ...
        if error: raise IOError("GetComment2 error {}".format(error))
    ...
    def GetFilters(self):
        ...
        if error: raise IOError("GetFilters error {}".format(error))
    ...
    def SetMassTolerance(self, userDefined=True, massTolerance=500.0, units=0):
        ...
        if error: raise IOError("SetMassTolerance error {}".format(error))
        return
    ...
    def GetMassTolerance(self):
        ...
        if error: raise IOError("GetMassTolerance error {}".format(error))
    ...
    def GetInstrumentDescription(self):
        ...
        if error: raise IOError("GetInstrumentDescription error {}".format(error))
    ...
    def GetInstrumentID(self):
        ...
        if error: raise IOError("GetInstrumentID error {}".format(error))
    ...
    def GetInstName(self):
        ...
        if error: raise IOError("GetInstName error {}".format(error))
    ...
    def GetInstModel(self):
        ...
        if error: raise IOError("GetInstModel error {}".format(error))
    ...
    def GetInstSerialNumber(self):
        ...
        if error: raise IOError("GetInstSerialNumber error {}".format(error))
    ...
    def GetInstSoftwareVersion(self):
        ...
        if error: raise IOError("GetInstSoftwareVersion error {}".format(error))
    ...
    def GetInstHardwareVersion(self):
        ...
        if error: raise IOError("GetInstHardwareVersion error {}".format(error))
    ...
    def GetInstFlags(self):
        ...
        if error: raise IOError("GetInstFlags error {}".format(error))
    ...
    def GetInstNumChannelLabels(self):
        ...
        if error: raise IOError("GetInstNumChannelLabels error {}".format(error))
    ...
    def GetInstChannelLabel(self, channelLabelNumber=0):
        ...
        if error: raise IOError("GetInstChannelLabel error {}".format(error))
        return pbstrFlags.value
    ...
    def GetScanEventForScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetScanEventForScanNum error {}".format(error))
    ...
    def GetSegmentAndEventForScanNum(self, scanNumber):  # NOT GetSegmentAndScanEventForScanNum
        ...
        if error: raise IOError("GetSegmentAndEventForScanNum error {}".format(error))
        return pbstrScanEvent.value
    ...
    def GetCycleNumberFromScanNumber(self, scanNumber):
        ...
        if error: raise IOError("GetCycleNumberFromScanNumber error {}".format(error))
    ...
    def GetAValueFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetAValueFromScanNum error {}".format(error))
    ...
    def GetBValueFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetBValueFromScanNum error {}".format(error))
        return pnXValue.value
    ...
    def GetFValueFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetFValueFromScanNum error {}".format(error))
        return pnXValue.value
    ...
    def GetKValueFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetKValueFromScanNum error {}".format(error))
        return pnXValue.value
    ...
    def GetRValueFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetRValueFromScanNum error {}".format(error))
        return pnXValue.value
    ...
    def GetVValueFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetVValueFromScanNum error {}".format(error))
        return pnXValue.value
    ...
    def GetMSXMultiplexValueFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetMSXMultiplexValueFromScanNum error {}".format(error))
    ...
    def GetNumberOfMassRangesFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetNumberOfMassRangesFromScanNum error {}".format(error))
        return result.value
    ...
    def GetMassRangeFromScanNum(self, scanNumber, massRangeIndex):
        ...
        if error: raise IOError("GetMassRangeFromScanNum error {}".format(error))
    ...
    def GetNumberOfSourceFragmentsFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetNumberOfSourceFragmentsFromScanNum error {}".format(error))
        return result.value
    ...
    def GetSourceFragmentValueFromScanNum(self, scanNumber, sourceFragmentIndex):
        ...
        if error: raise IOError("GetSourceFragmentValueFromScanNum error {}".format(error))
    ...
    def GetNumberOfSourceFragmentationMassRangesFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetNumberOfSourceFragmentationMassRangesFromScanNum error {}".format(error))
        return result.value
    ...
    def GetSourceFragmentationMassRangeFromScanNum(self, scanNumber, sourceFragmentIndex):
        ...
        if error: raise IOError("GetSourceFragmentationMassRangeFromScanNum error {}".format(error))
    ...
    def GetIsolationWidthForScanNum(self, scanNumber, MSOrder):
        ...
        if error: raise IOError("GetIsolationWidthForScanNum error {}".format(error))
        return result.value
    ...
    def GetCollisionEnergyForScanNum(self, scanNumber, MSOrder):
        ...
        if error: raise IOError("GetCollisionEnergyForScanNum error {}".format(error))
        return result.value
    ...
    def GetActivationTypeForScanNum(self, scanNumber, MSOrder):
        ...
        if error: raise IOError("GetActivationTypeForScanNum error {}".format(error))
    ...
    def GetMassAnalyzerTypeForScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetMassAnalyzerTypeForScanNum error {}".format(error))
    ...
    def GetDetectorTypeForScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetDetectorTypeForScanNum error {}".format(error))
    ...
    def GetScanTypeForScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetScanTypeForScanNum error {}".format(error))
    ...
    def GetNumberOfMassCalibratorsFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetNumberOfMassCalibratorsFromScanNum error {}".format(error))
        return result.value
    ...
    def GetMassCalibrationValueFromScanNum(self, scanNumber, massCalibrationIndex):
        ...
        error = self.source.GetMassCalibrationValueFromScanNum(c_long(scanNumber), c_long(massCalibrationIndex),
                                                               byref(result))
        if error: raise IOError("GetMassCalibrationValueFromScanNum error {}".format(error))
        return result.value
    ...
    def GetFilterMassPrecision(self):
        ...
        if error: raise IOError("GetFilterMassPrecision error {}".format(error))
        return result.value
    ...
    def GetMassPrecisionEstimate(self, scanNumber):
        ...
        if error: raise IOError("GetMassPrecisionEstimate error {}".format(error))
        return result.value
    ...
    def IsQExactive(self):
        ...
        if error: raise IOError("IsQExactive error {}".format(error))
    ...
    def GetMassResolution(self):
        ...
        if error: raise IOError("GetMassResolution error {}".format(error))
        return result.value
    ...
    def GetLowMass(self):
        ...
        if error: raise IOError("GetLowMass error {}".format(error))
    ...
    def GetHighMass(self):
        ...
        if error: raise IOError("GetHighMass error {}".format(error))
    ...
    def GetStartTime(self):
        ...
        if error: raise IOError("GetStartTime error {}".format(error))
        return pdStartTime.value

    def GetEndTime(self):
        pdEndTime = c_double()
        error = self.source.GetEndTime(byref(pdEndTime))
        if error: raise IOError("GetEndTime error {}".format(error))
    ...
    def GetNumSpectra(self):
        ...
        if error: raise IOError("GetNumSpectra error {}".format(error))
    ...
    def GetFirstSpectrumNumber(self):
        ...
        if error: raise IOError("GetFirstSpectrumNumber error {}".format(error))
    ...
    def GetLastSpectrumNumber(self):
        ...
        if error: raise IOError("GetLastSpectrumNumber error {}".format(error))
    ...
    def IsProfileScanForScanNum(self, scanNumber):
        ...
        if error: raise IOError("IsProfileScanForScanNum error {}".format(error))
    ...
    def IsCentroidScanForScanNum(self, scanNumber):
        ...
        if error: raise IOError("IsCentroidScanForScanNum error {}".format(error))
    ...
    def GetMassListRangeFromScanNum(self, scanNumber,
        ...
        error = self.source.GetMassListRangeFromScanNum(c_long(scanNumber), filter, intensityCutoffType,
                                                        ...
                                                        byref(pnArraySize))
        if error: raise IOError("GetMassListRangeFromScanNum error {}".format(error))
        return peakList.value, peakFlags.value
    ...
    def GetSegmentedMassListFromScanNum(self, scanNumber,
        ...
        error = self.source.GetSegmentedMassListFromScanNum(byref(c_long(scanNumber)),
                                                            ...
                                                            byref(pnNumSegments),
                                                            byref(massRange))
        if error: raise IOError("GetSegmentedMassListFromScanNum error {}".format(error))
    ...
    def GetAverageMassList(self, firstAvgScanNumber,
        ...
        error = self.source.GetAverageMassList(byref(c_long(firstAvgScanNumber)),
                                               ...
                                               byref(peakFlags),
                                               byref(pnArraySize))
        if error: raise IOError("GetAverageMassList error {}".format(error))
        return peakList.value, peakFlags.value
    ...
    def GetAveragedMassSpectrum(self, listOfScanNumbers, centroidResult=False):
        ...
        error = self.source.GetAveragedMassSpectrum(x,
                                                    ...
                                                    byref(peakFlags),
                                                    byref(pnArraySize))
        if error: raise IOError("GetAveragedMassSpectrum error {}".format(error))
        return peakList.value, peakFlags.value
    ...
    def GetSummedMassSpectrum(self, listOfScanNumbers, centroidResult=False):
        ...
        error = self.source.GetSummedMassSpectrum(x,
                                                  ...
                                                  byref(peakFlags),
                                                  byref(pnArraySize))
        if error: raise IOError("GetSummedMassSpectrum error {}".format(error))
        return peakList.value, peakFlags.value
    ...
    def IncludeReferenceAndExceptionData(self, boolean):
        ...
        if error: raise IOError("IncludeReferenceAndExceptionData error {}".format(error))
        return

    def GetLabelData(self,
                     scanNumber):  # This is a higher level function than GetMassListRangeFromScanNum, only for profile data (MS1).
        ...
        if error: raise IOError("GetLabelData error {}".format(error))
    ...
    def GetAveragedLabelData(self, listOfScanNumbers):
        ...
        error = self.source.GetAveragedLabelData(x,
                                                 ...
                                                 byref(peakFlags),
                                                 byref(pnArraySize))
        if error: raise IOError("GetAveragedLabelData error {}".format(error))
        Flags = namedtuple('Flags', 'saturated fragmented merged exception reference modified')
    ...
    def GetNoiseData(self, scanNumber):  # already included in GetLabelData ?
        ...
        if error: raise IOError("GetNoiseData error {}".format(error))
    ...
    def GetFullMSOrderPrecursorDataFromScanNum(self, scanNumber, MSOrder):
        ...
        if error: raise IOError("GetFullMSOrderPrecursorDataFromScanNum error {}".format(error))
        FullMSOrderPrecursorData = namedtuple('FullMSOrderPrecursorData',
                                              'precursorMass isolationWidth collisionEnergy collisionEnergyValid rangeIsValid firstPrecursorMass lastPrecursorMass isolationWidthOffset')
    ...
    def GetNumberOfMSOrdersFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetNumberOfMSOrdersFromScanNum error {}".format(error))
        return result.value
    ...
    def GetPrecursorInfoFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetPrecursorInfoFromScanNum error {}".format(error))
        if variant.value:
    ...
    def GetPrecursorRangeForScanNum(self, scanNumber, MSOrder):
        ...
        error = self.source.GetPrecursorRangeForScanNum(c_long(scanNumber), c_long(MSOrder),
                                                        ...
                                                        byref(pbIsValid))
        if error: raise IOError("GetPrecursorRangeForScanNum error {}".format(error))
    ...
    def GetScanHeaderInfoForScanNum(self, scanNumber):  # "View/Scan header", upper part
        ...
        if error: raise IOError("GetScanHeaderInfoForScanNum error {}".format(error))
        for k in header:
    ...
    def GetTrailerExtraForScanNum(self, scanNumber):  # "View/Scan header", lower part
        ...
        if error: raise IOError("GetTrailerExtraForScanNum error {}".format(error))
    ...
    def GetNumTuneData(self):
        ...
        if error: raise IOError("GetNumTuneData error {}".format(error))
    ...
    def GetTuneData(self, segmentNumber=1):  # "View/Report/Tune Method"
        ...
        if error: raise IOError("GetTuneData error {}".format(error))
    ...
    def GetNumInstMethods(self):
        ...
        if error: raise IOError("GetNumInstMethods error {}".format(error))
    ...
    def GetInstMethod(self, instMethodItem=0):  # "View/Report/Instrument Method"
        ...
        if error: raise IOError("GetInstMethod error {}".format(error))
    ...
    def GetInstMethodNames(self):
        ...
        if error: raise IOError("GetInstMethodNames error {}".format(error))
    ...
    def ExtractInstMethodFromRaw(self, instMethodFileName):
        ...
        if error: raise IOError("ExtractInstMethodFromRaw error {}".format(error))
        return
    ...
    def GetNumStatusLog(self):
        ...
        if error: raise IOError("GetNumStatusLog error {}".format(error))
    ...
    def GetStatusLogForScanNum(self, scanNumber):  # "View/Report/Status Log"
        ...
        error = self.source.GetStatusLogForScanNum(c_long(scanNumber), byref(pdStatusLogRT), pvarLabels, pvarValues,
                                                   byref(pnArraySize))
        if error: raise IOError("GetStatusLogForScanNum error {}".format(error))
    ...
    def GetStatusLogForPos(self, position=0):
        ...
        if error: raise IOError("GetStatusLogForPos error {}".format(error))
    ...
    def GetStatusLogPlottableIndex(self):
        ...
        if error: raise IOError("GetStatusLogPlottableIndex error {}".format(error))
    ...
    def GetNumErrorLog(self):
        ...
        if error: raise IOError("GetNumErrorLog error {}".format(error))
    ...
    def GetErrorLogItem(self, itemNumber=1):  # "View/Report/Error Log"
        ...
        if error: raise IOError("GetErrorLogItem error {}".format(error))
    ...
    def GetChroData(self, startTime=0.0,
        ...
        error = self.source.GetChroData(chroType1,
                                        ...
                                        pvarPeakFlags,
                                        byref(pnArraySize))
        if error: raise IOError("GetChroData error {}".format(error))
    ...
    def GetChroByCompoundName(self, compoundNamesList=None,
        ...
        error = self.source.GetChroByCompoundName(c_long(chroType1),
                                                  ...
                                                  pvarPeakFlags,
                                                  byref(pnArraySize))
        if error: raise IOError("GetChroByCompoundName error {}".format(error))
        return pvarChroData.value, pvarPeakFlags.value
    ...
    def GetUniqueCompoundNames(self):
        ...
        if error: raise IOError("GetUniqueCompoundNames error {}".format(error))
    ...
    def GetCompoundNameFromScanNum(self, scanNumber):
        ...
        if error: raise IOError("GetCompoundNameFromScanNum error {}".format(error))
...
def try_method(obj, name, args=[], kwargs={}):
    try:
        ...
        return "Failed ({}): {}".format(e.__class__.__name__, e)


def try_and_format(obj, name, args=[], kwargs={}):
    if args and kwargs:
        call = "{}({}, {})"
    else:
        call = "{}({}{})"
    ...
    result = try_method(obj, name, args, kwargs)
    if not result:  # make result visible when printed
        result = repr(result)

    return "{}: {}".format(call, result)


def to_tsv(rawfile):
    out_name = os.path.splitext(rawfile.filename)[0]
    f = open(out_name + '.tsv', 'wt')
    ...
    for i in range(rawfile.FirstSpectrumNumber, rawfile.LastSpectrumNumber + 1):
        RT =  try_method(rawfile, 'RTFromScanNum', [i])
        data = [
            i,
            RT,
            try_method(rawfile, 'ScanNumFromRT', [RT]),
            try_method(rawfile, 'GetFilterForScanNum', [i]),
            try_method(rawfile, 'GetMSOrderForScanNum', [i]),
            try_method(rawfile, 'GetNumberOfMSOrdersFromScanNum', [i]),
            try_method(rawfile, 'GetScanTypeForScanNum', [i]),
            try_method(rawfile, 'GetDetectorTypeForScanNum', [i]),
            try_method(rawfile, 'GetMassAnalyzerTypeForScanNum', [i]),
            try_method(rawfile, 'GetActivationTypeForScanNum', [i], {'MSOrder': 2}),
            try_method(rawfile, 'IsProfileScanForScanNum', [i]),
            try_method(rawfile, 'IsCentroidScanForScanNum', [i]),
            try_method(rawfile, 'GetIsolationWidthForScanNum', [i], {'MSOrder': 1}),
            try_method(rawfile, 'GetCollisionEnergyForScanNum', [i], {'MSOrder': 1}),
            try_method(rawfile, 'GetPrecursorInfoFromScanNum', [i]),
            try_method(rawfile, 'GetMassCalibrationValueFromScanNum', [i], {'massCalibrationIndex': 0}),
            try_method(rawfile, 'GetScanEventForScanNum', [i]),
            try_method(rawfile, 'GetSegmentAndEventForScanNum', [i]),
            try_method(rawfile, 'GetCycleNumberFromScanNumber', [i]),
            try_method(rawfile, 'GetAValueFromScanNum', [i]),
            try_method(rawfile, 'GetBValueFromScanNum', [i]),
            try_method(rawfile, 'GetKValueFromScanNum', [i]),
            try_method(rawfile, 'GetRValueFromScanNum', [i]),
            try_method(rawfile, 'GetVValueFromScanNum', [i]),
            try_method(rawfile, 'GetMSXMultiplexValueFromScanNum', [i]),
            try_method(rawfile, 'GetCompoundNameFromScanNum', [i]),
            try_method(rawfile, 'GetNumberOfMassRangesFromScanNum', [i]),
            try_method(rawfile, 'GetMassRangeFromScanNum', [i, 0]),
            try_method(rawfile, 'GetMassRangeFromScanNum', [i, 1]),
            try_method(rawfile, 'GetNumberOfSourceFragmentsFromScanNum', [i]),
            try_method(rawfile, 'GetSourceFragmentValueFromScanNum', [i, 0]),
            try_method(rawfile, 'GetNumberOfSourceFragmentationMassRangesFromScanNum', [i])
            ]
...
if __name__ == "__main__":
    ...
    methods = [
        ...
        ('GetNumberOfControllersOfType', [-1], {}),
        ('GetNumberOfControllersOfType', [0], {}),
        ('GetNumberOfControllersOfType', [1], {}),
        ('GetNumberOfControllersOfType', [2], {}),
        ('GetNumberOfControllersOfType', [3], {}),
        ('GetNumberOfControllersOfType', [4], {}),
        ('GetControllerType', [0], {}),
        ('GetControllerType', [1], {}),
        ('GetControllerType', [2], {}),
        ('GetControllerType', [3], {}),
        ...
        ('SetMassTolerance',[], {'userDefined': True, 'massTolerance': 555.0, 'units': 2}),
        ('GetMassTolerance', [], {}),
        ('SetMassTolerance',[], {'userDefined': False, 'massTolerance': 555.0, 'units': 0} ),
        ('GetMassResolution',[], {}),
        ('GetNumTrailerExtra', [], {}),
        ('GetLowMass', [], {}),
        ('GetHighMass', [], {}),
    ...
    for method in methods:
        print(try_and_format(rawfile, *method))
    ...
    methods = [
        ...
        ('GetInstChannelLabel', [0], {}),
        ('IsQExactive', [], {}), # Not implemented in MSFileReader 3.0.29.0
        ]
    for method in methods:
        print(try_and_format(rawfile, *method))
    ...
    methods = [
        ('GetScanHeaderInfoForScanNum', [scanNumber], {}),  # "View/Scan header", upper part
        ('GetTrailerExtraForScanNum', [scanNumber], {}),  # "View/Scan header", lower part
        ('GetNumTuneData', [], {}),
        ('GetTuneData', [0], {}), # "View/Report/Tune Method"
        ('GetNumInstMethods',[], {}),
        ('GetInstMethodNames', [], {}),
        ]
    ...
    try:
        for i in range(rawfile.GetNumInstMethods()):
            methods.append(('GetInstMethod', [i], {}))
    except:
        pass

    methods += [
        ('ExtractInstMethodFromRaw', [rawfile.filename + '.meth'], {}),
        ...
        ('GetSeqRowComment', [], {}),
        ('GetSeqRowLevelName', [], {}),
        ('GetSeqRowUserText', [], {'index':0}),
        ('GetSeqRowUserText', [], {'index':1}),
        ('GetSeqRowUserText', [], {'index':2}),
        ('GetSeqRowUserText', [], {'index':3}),
        ('GetSeqRowUserText', [], {'index':4}),
        ...
        ('GetSeqRowUserLabel', [], {'index':0}),
        ('GetSeqRowUserLabel', [], {'index':1}),
        ('GetSeqRowUserLabel', [], {'index':2}),
        ('GetSeqRowUserLabel', [], {'index':3}),
        ('GetSeqRowUserLabel', [], {'index':4}),
        ('GetSeqRowUserTextEx', [], {'index':0}),
        ('GetSeqRowUserTextEx', [], {'index':1}),
        ('GetSeqRowUserTextEx', [], {'index':2}),
        ('GetSeqRowUserTextEx', [], {'index':3}),
        ('GetSeqRowUserTextEx', [], {'index':4}),
        ('GetSeqRowBarcode', [], {}),
        ('GetSeqRowBarcodeStatus', [], {}),
        # # # # # # # "View/Report/Sample Information" END
        ('GetNumStatusLog', [], {}),
        ('GetStatusLogForScanNum', [scanNumber], {}),  # "View/Report/Status Log"
    ...
    try:
        for i in range(rawfile.GetNumErrorLog()):
            methods.append(('GetErrorLogItem', [i], {}))  # "View/Report/Error Log"
    except:
        pass
    ...
    print()
    print('############################################## XCALIBUR INTERFACE END ## Results truncated to 250 characters')

    methods = [
        ('GetMassListFromScanNum', [scanNumber], {}),
        ('GetMassListRangeFromScanNum', [scanNumber], {}),
        ('GetSegmentedMassListFromScanNum', [scanNumber], {}),
        ('GetAverageMassList', [scanNumber, scanNumber + 10], {}),
        ('GetAveragedMassSpectrum', [[scanNumber, scanNumber + 5, scanNumber + 10]], {}),
        ('GetSummedMassSpectrum', [[scanNumber, scanNumber + 5, scanNumber + 10]], {}),
        ('GetLabelData', [scanNumber], {}),
        ('GetAveragedLabelData', [[scanNumber, scanNumber + 5, scanNumber + 10]], {}),
        ('GetAllMSOrderData', [scanNumber], {}),
        ('GetChroData', [], {
            'startTime':rawfile.StartTime,
            'endTime':rawfile.EndTime,
            'massRange1':"{}-{}".format(rawfile.LowMass, rawfile.HighMass),
            'filter':"Full ms "}),
        ('GetChroByCompoundName', [["methyltestosterone"]], {}),
        ('GetMassPrecisionEstimate', [scanNumber], {}),
        ('GetFullMSOrderPrecursorDataFromScanNum', [scanNumber, 0], {}),
        ('GetFullMSOrderPrecursorDataFromScanNum', [scanNumber, 1], {}),
        ('GetPrecursorInfoFromScanNum', [scanNumber], {}),
    ]

    for method in methods:
        print(try_and_format(rawfile, *method)[:250])
    rawfile.Close()
    sys.exit()
